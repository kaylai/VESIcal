...
volatiles = ['H2O', 'CO2']
oxideMass = {'SiO2': 28.085+15.999*2, 'MgO': 24.305+15.999, 'FeO': 55.845+15.999, 'CaO': 40.078+15.999, 'Al2O3': 2*26.982+15.999*3, 'Na2O': 22.99*2+15.999,
             'K2O': 39.098*2+15.999, 'MnO': 54.938+15.999, 'TiO2': 79.867, 'P2O5': 2*30.974+5*15.999, 'Cr2O3': 151.992,
             'NiO': 58.693+16, 'CoO': 44.01, 'Fe2O3': 55.845*2+15.999*3,
             'H2O': 18.02, 'CO2': 44.01}
...
CationMass = {'SiO2': 28.085, 'MgO': 24.305, 'FeO': 55.845, 'CaO': 40.078, 'Al2O3': 26.982, 'Na2O': 22.990,
             ...
             'NiO': 58.693, 'CoO': 28.01, 'Fe2O3': 55.845, 'H2O': 1.01, 'CO2': 12.011}
