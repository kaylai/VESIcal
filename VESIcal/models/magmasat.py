...
# START duanDriver suppression code
# below function stops printing of duanDriver messages from thermoengine
import os
...
# END duanDriver supression code
...
class MagmaSat(model_classes.Model):
    ...
    def calculate_saturation_pressure(self, sample, temperature, verbose=False,
        ...
        # Refined searches
        refined_search_number = 0
        pressure_change = 100
        while refined_search_number < refinement_level:
            refined_search_number += 1
            pressure_change = pressure_change / 10
